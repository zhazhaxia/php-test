...
window.onload = function() {
  ...
  err('
截图成功！<div class="sword">（可点右键另存为）</div><center><a href="'.get_en_url($web['img_up_dir'].'/'.$web['img_name_b']).'.'.$web['img_up_format'].'" target="_blank"><img class="i_face_small" src="'.get_en_url($web['img_up_dir'].'/'.$web['img_name_b']).'.'.$web['img_up_format'].'?'.$t.'" /></a></center>');
  exit;
